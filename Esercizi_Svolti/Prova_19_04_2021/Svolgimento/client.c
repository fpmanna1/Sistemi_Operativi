...
void ClientAuth(int id_coda_auth_req, int id_coda_auth_resp, int id_coda_elab_req, int id_coda_elab_resp) {
    ...
    for(int i=0; i<5; i++) {
        ...
        /*RichiestaElab msg_elab_req;
        RispostaElab msg_elab_resp;
        int id_coda_auth_req, int id_coda_auth_resp, int id_coda_elab_req, int id_coda_elab_resp */
        ...
        msgsnd(id_coda_elab_req, (void*)&msg_elab_req, sizeof(RichiestaElab)-sizeof(long), 0);
        
        printf("Client Auth (%d): attesa risposta elaborazione\n", getpid());

        /* TBD: Ricezione risposta elaborazione */
		msgrcv(id_coda_elab_resp, (void*)&msg_elab_resp, sizeof(RispostaElab)-sizeof(long), getpid(), 0);
